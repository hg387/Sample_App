export default async function handler (req, res) {
    ...
    var URL = `https://api.foursquare.com/v2/venues/search?ll=${lat},${lng}&query=${search}&client_id=${process.env.FOURSQUARE_CLIENT_ID}&client_secret=${process.env.FOURSQUARE_CLIENT_SECRET}&v=20210909`
